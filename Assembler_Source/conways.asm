...
matrix_modify:
	...
	loadn r1, #0	; Inicializando o valor de r1 para 0.
	loadn r5, #0	; Inicializando r5 (Não sei se é necessário.)
...
matrix_simulate:
	...
	; INICIALIZANDO VARIÁVEIS
	loadn r2, #0	; Contador ; r2 := i
	loadn r3, #0	; Contador ; r3 := j
	loadn r7, #0	; Numero de vizinhos vivos
...
cell_getLifeEnergy:
	...
	; INICIALIZANDO CONSTANTES
	loadn r4, #0 ; Contador ; r4 := i
	loadn r5, #0 ; Contador ; r5 := j
	
	; INICIALIZANDO VARIÁVEIS
	loadn r7, #0 ; Contador de vida nos vizinhos
